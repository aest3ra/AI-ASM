...
from orbis.agent.safety import interaction_key, is_click_candidate, label_for_ref
...
class NetworkDelta:
    ...
    unique_new_requests_count: int = 0
    unique_new_requests: tuple[str, ...] = ()
    unique_api_new_requests_count: int = 0
    unique_api_new_requests: tuple[str, ...] = ()
    ...
    def as_dict(self) -> dict[str, Any]:
        return {
            ...
            "unique_new_requests_count": self.unique_new_requests_count,
            "unique_new_requests": list(self.unique_new_requests),
            "unique_api_new_requests_count": self.unique_api_new_requests_count,
            "unique_api_new_requests": list(self.unique_api_new_requests),
