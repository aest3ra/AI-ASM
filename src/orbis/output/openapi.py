...
from orbis.schema.inferrer import merge_json_schemas
    ...
    *,
    ...
    spec: dict[str, Any] = {
        ...
        "info": {
            "title": title,
            "version": version,
            "description": "Generated from orbis observed API traffic.",
        },
        "paths": {},
    }
